...
#include "turbulentSeededDFSEMInletFvPatchVectorField.H"
#include "volFields.H"
...
Foam::label Foam::turbulentSeededDFSEMInletFvPatchVectorField::seedIterMax_ = 1000;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::turbulentSeededDFSEMInletFvPatchVectorField::writeEddyOBJ() const
{
    {
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::writeLumleyCoeffs() const
{
...
Foam::turbulentSeededDFSEMInletFvPatchVectorField::patchMapper() const
{
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::initialisePatch()
{
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::initialiseEddyBox()
{
...
Foam::pointIndexHit Foam::turbulentSeededDFSEMInletFvPatchVectorField::setNewPosition
(
    const bool global
)
{
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::initialiseEddies()
{
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::convectEddies
(
    const scalar deltaT
)
{
...
Foam::vector Foam::turbulentSeededDFSEMInletFvPatchVectorField::uDashEddy
(
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::calcOverlappingProcEddies
(
...
Foam::turbulentSeededDFSEMInletFvPatchVectorField::
turbulentSeededDFSEMInletFvPatchVectorField
(
    const fvPatch& p,
...
turbulentSeededDFSEMInletFvPatchVectorField
(
    const turbulentSeededDFSEMInletFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
:
    ...
    patchNormal_(Zero),
    v0_(Zero),
    rndGen_(dict.get<label>("seed")),
    seed_(dict.get<label>("seed")), // custom
    sigmax_(size(), Zero),
    maxSigmaX_(Zero),
    nEddy_(Zero),
    curTimeIndex_(-1),
...
bool Foam::turbulentSeededDFSEMInletFvPatchVectorField::checkStresses
(
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::autoMap
(
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::rmap
(
...
)
{
    ...
    const turbulentSeededDFSEMInletFvPatchVectorField& dfsemptf =
        refCast<const turbulentSeededDFSEMInletFvPatchVectorField>(ptf);
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    if (curTimeIndex_ != db().time().timeIndex())
    {
        ...
        scalar seeds = rndGen_.seed();
        reduce(seeds, sumOp<label>());
        seeds = seeds/36;
        Info << "THE RANDOM SEED IS: " << seeds << endl;
...
void Foam::turbulentSeededDFSEMInletFvPatchVectorField::write(Ostream& os) const
{
